...
__all__ = [
    ...
    'SpeechVisemeType', 'SASClosed', 'SRADynamic', 'SVSFUnusedFlags',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRRTLength', 'SVSFIsNotXML',
    'DISPID_SLPs_NewEnum', 'ISpEventSink',
    'DISPID_SpeechLexiconWords', 'SDTDisplayText',
    'SGDSActiveWithAutoPause', 'DISPID_SOTsCount', 'SPRS_INACTIVE',
    'eLEXTYPE_MORPHOLOGY', 'ISpeechObjectToken',
    'DISPID_SpeechRecognizer', 'SPWORDTYPE',
    'DISPID_SOTCreateInstance', 'DISPID_SpeechLexicon',
    'SPEI_SR_BOOKMARK', 'SP_VISEME_15', 'SPEI_INTERFERENCE',
    'SRERecoOtherContext', 'SGLexical', 'SREPhraseStart',
    ...
    'DISPID_SLGetPronunciations', 'SINoise',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPPsItem', 'DISPID_SPEAudioTimeOffset',
    'SpeechGrammarWordType', 'eLEXTYPE_PRIVATE9',
    ...
    'DISPID_SPIAudioSizeBytes', 'DISPID_SpeechObjectToken',
    'ISpRecoCategory', 'DISPID_SPCIdToPhone', 'SPBOOKMARKOPTIONS',
    'SPEVENTSOURCEINFO', 'DISPID_SpeechGrammarRuleState',
    'SPGS_DISABLED', 'SPRS_ACTIVE', 'SpeechPropertyResponseSpeed',
    'SpeechGrammarTagWildcard', 'SPLO_STATIC', 'SPBINARYGRAMMAR',
    'DISPID_SVSpeakStream', 'SpAudioFormat', 'DISPID_SLWsCount',
    'SAFT32kHz8BitMono', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRGCmdSetRuleIdState', 'SAFTCCITT_uLaw_8kHzMono',
    'eLEXTYPE_PRIVATE8', 'DISPID_SPRFirstElement',
    'SAFT11kHz16BitMono', 'SPPHRASEPROPERTY', 'SpeechMicTraining',
    'SpCompressedLexicon', 'SpStream',
    'DISPID_SPIAudioStreamPosition',
    'DISPID_SRCERecognitionForOtherContext', 'SSTTDictation',
    'DISPID_SVGetAudioOutputs', 'ISpeechPhraseRules',
    'DISPID_SVEPhoneme', 'DISPID_SPRNumberOfElements',
    'DISPID_SGRSTsCount', 'eLEXTYPE_RESERVED6', 'SAFT12kHz16BitMono',
    'DISPID_SpeechPhraseElements', 'SpeechUserTraining',
    'SpeechFormatType', 'SPEI_RESERVED2',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVP_15',
    'SREAllEvents', 'DISPID_SGRsItem', 'SPDKL_CurrentConfig',
    'DISPID_SVSCurrentStreamNumber', 'SPAR_Medium',
    'DISPID_SABIEventBias', 'SpUnCompressedLexicon', 'SP_VISEME_18',
    'SVP_3', 'DISPID_SBSSeek', 'SVSFNLPSpeakPunc', 'SPRST_INACTIVE',
    'SLOStatic', 'DISPID_SVRate', 'DISPID_SOTCSetId',
    'DISPID_SASetState', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SGRSTNextState', 'SpeechTokenKeyAttributes',
    'ISpeechRecoResultTimes', 'SP_VISEME_14', 'SPWT_LEXICAL',
    'ISpeechGrammarRule', 'DISPID_SVSInputWordPosition',
    'SP_VISEME_13', 'DISPID_SRCVoicePurgeEvent',
    'SSSPTRelativeToStart', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SGRInitialState', 'SITooSlow', 'SPEI_MIN_TTS',
    'SRAExport', 'SITooFast', 'ISpeechPhraseProperties',
    'SpeechTokenKeyUI', 'SpeechPropertyNormalConfidenceThreshold',
    'SAFT11kHz8BitMono', 'SpeechCategoryVoices', 'SPEI_RESERVED1',
    'DISPID_SVSPhonemeId', 'DISPID_SVSInputSentenceLength',
    '_SPAUDIOSTATE', 'SDKLCurrentConfig', 'ISpeechRecognizer',
    'DISPID_SPPNumberOfElements', 'DISPID_SpeechPhraseRules',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRStatus', 'SRESoundStart', 'DISPID_SRCESoundStart',
    'SPFM_OPEN_READWRITE', 'Speech_Default_Weight', 'ISpEventSource',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SRState',
    'SpeechDataKeyLocation', 'DISPID_SPPName',
    'SAFTCCITT_uLaw_44kHzMono', 'SPEI_TTS_PRIVATE', 'DISPID_SRCState',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPIAudioSizeTime',
    'ISpeechVoiceStatus', 'SP_VISEME_8', 'STCAll', 'DISPID_SRCResume',
    'Speech_Max_Word_Length', 'DISPID_SRGDictationLoad',
    'DISPID_SRGCommit', 'SRSActive', 'SVSFPersistXML', 'SPXRO_SML',
    'DISPID_SGRs_NewEnum', 'ISpeechVoice', 'SREPrivate',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPAsCount', 'SPEI_VISEME',
    'SDTLexicalForm', 'IEnumString', 'SAFT44kHz16BitStereo',
    'SpeechVisemeFeature', 'SVP_9', 'DISPID_SPRulesCount',
    'SpeechRecoProfileProperties', 'SAFT11kHz16BitStereo',
    'DISPID_SpeechVoice', 'SECFDefault',
    'DISPID_SPAStartElementInResult', 'DISPID_SPIGetText',
    'ISpeechBaseStream', 'SPEI_PROPERTY_STRING_CHANGE',
    'ISpRecoContext', 'Speech_StreamPos_Asap',
    'SDA_Two_Trailing_Spaces', 'DISPID_SMSGetData',
    'SAFT8kHz16BitStereo', 'SP_VISEME_7', 'SPFM_NUM_MODES',
    'SpeechDictationTopicSpelling', 'ISpPhraseAlt',
    'ISpeechPhraseProperty', 'SpObjectToken',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SGRSTText',
    'DISPID_SABufferInfo', 'ISpRecognizer',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SOTDisplayUI',
    'SpeechRecoEvents', 'DISPID_SpeechPhraseBuilder',
    'SECFIgnoreWidth', 'SAFT32kHz16BitStereo', 'SPPHRASEELEMENT',
    'SGRSTTRule', 'DISPID_SGRSTPropertyName', 'DISPID_SGRSTs_NewEnum',
    'SPRULESTATE', 'SPRST_NUM_STATES', 'SPCT_SUB_DICTATION',
    'SPWORDPRONUNCIATION', 'SPRST_ACTIVE_ALWAYS', 'SAFT22kHz8BitMono',
    'SDTAlternates', 'SRAORetainAudio', 'SVP_7', 'DISPID_SPPId',
    'ISpeechLexiconWords', 'SITooLoud', 'SpeechVoiceEvents',
    'DISPID_SPRuleFirstElement', 'DISPIDSPTSI_SelectionLength',
    'SPRST_ACTIVE', 'DISPID_SpeechCustomStream', 'STCInprocServer',
    ...
    'tagSPPROPERTYINFO', 'ISpeechLexiconWord', 'DISPID_SPCPhoneToId',
    'eLEXTYPE_PRIVATE4', 'eLEXTYPE_PRIVATE17',
    'DISPID_SPEActualConfidence', 'SPEI_VOICE_CHANGE',
    'SPEI_FALSE_RECOGNITION', 'SVP_0', 'SAFT44kHz8BitMono',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SRGId',
    'SpSharedRecoContext', 'SPDKL_DefaultLocation',
    'SpeechRuleAttributes', 'SAFT16kHz8BitStereo',
    ...
    'SPRECOCONTEXTSTATUS', 'SpeechRegistryUserRoot',
    'DISPID_SDKEnumValues', 'SFTSREngine',
    'DISPID_SpeechWaveFormatEx', 'SWPKnownWordPronounceable',
    'ISpeechLexiconPronunciation', 'ISpNotifySink',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SDKEnumKeys', 'SAFTCCITT_uLaw_11kHzMono',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpObjectToken', 'SVP_2',
    'DISPID_SpeechPhraseElement', 'SpeechWordType', 'DISPID_SVSkip',
    'SAFT16kHz16BitMono', 'SAFT48kHz16BitMono',
    'SpeechTokenShellFolder', 'DISPID_SLPsCount',
    'SpeechGrammarTagDictation', 'Speech_StreamPos_RealTime',
    'SRCS_Disabled', 'DISPID_SRCEStartStream', 'SPPS_NotOverriden',
    'eLEXTYPE_USER_SHORTCUT', 'SpMMAudioEnum',
    'DISPID_SRCCmdMaxAlternates', 'eLEXTYPE_PRIVATE6',
    'ISpeechPhraseAlternate', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpeechObjectTokenCategory', 'SpeechCategoryPhoneConverters',
    'SPSEMANTICFORMAT', 'DISPID_SRCAudioInInterferenceStatus',
    'SSFMOpenReadWrite', 'DISPID_SGRSTransitions', 'SVEAudioLevel',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRCERecognition',
    'DISPID_SPEDisplayText', 'SREStateChange', 'DISPID_SGRSTRule',
    'ISpeechWaveFormatEx', 'DISPID_SBSWrite', 'SPWF_INPUT',
    'DISPID_SPEsItem', 'SpeechPartOfSpeech', 'DISPID_SRCEPhraseStart',
    'ISpeechRecoResult', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SGRsDynamic', 'eLEXTYPE_RESERVED4', 'eLEXTYPE_PRIVATE14',
    'DISPID_SVSLastStreamNumberQueued', 'eWORDTYPE_DELETED',
    'SAFTExtendedAudioFormat', 'SP_VISEME_4', 'SPEI_HYPOTHESIS',
    'SPSMF_UPS', 'DISPID_SRAudioInputStream', 'SpPhraseInfoBuilder',
    'SLODynamic', 'SAFTCCITT_ALaw_8kHzStereo', 'SP_VISEME_20',
    'SPINTERFERENCE', 'SGLexicalNoSpecialChars',
    'ISpeechGrammarRuleStateTransitions', 'SPPHRASE',
    'DISPID_SpeechRecoResultTimes', 'SpeechCategoryRecoProfiles',
    'DISPID_SGRSTPropertyValue', 'DISPID_SOTDataKey',
    'DISPID_SLPLangId', 'DISPID_SFSClose', 'SP_VISEME_17',
    'ISpeechPhraseElements', 'ISequentialStream',
    'SAFT48kHz16BitStereo', 'DISPID_SRGRecoContext',
    'DISPID_SGRAddResource', 'DISPID_SMSADeviceId',
    'SAFTGSM610_11kHzMono', 'SRTStandard', 'SAFT32kHz8BitStereo',
    'DISPID_SWFEBitsPerSample', 'SVEStartInputStream', 'SP_VISEME_6',
    'DISPID_SGRsAdd', 'DISPID_SBSRead', 'SAFTGSM610_22kHzMono',
    'eLEXTYPE_RESERVED9', 'SVP_5', 'eLEXTYPE_PRIVATE19',
    'DISPID_SPAs_NewEnum', 'DISPID_SPRsItem', 'SVSFParseSsml',
    'DISPID_SRCEEnginePrivate', 'DISPID_SRSClsidEngine',
    'DISPID_SPEAudioSizeTime', 'SPPHRASEREPLACEMENT', 'SRARoot',
    'DISPID_SRGCmdSetRuleState', 'SPEI_SR_PRIVATE',
    'SAFT22kHz16BitStereo', 'DISPID_SGRAddState', 'SPPS_LMA',
    'eLEXTYPE_PRIVATE16', 'SPEI_REQUEST_UI', 'DISPID_SGRId',
    'DISPID_SpeechGrammarRule', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPPS_RESERVED2', 'SPPS_RESERVED4', 'SVEWordBoundary',
    'DISPID_SDKOpenKey', 'DISPID_SWFEChannels',
    'DISPID_SPERequiredConfidence', 'DISPID_SDKDeleteValue',
    'ISpResourceManager', 'eLEXTYPE_PRIVATE1', 'SAFTADPCM_8kHzMono',
    'SPAO_RETAIN_AUDIO', '_ISpeechRecoContextEvents',
    'SPXMLRESULTOPTIONS', 'SpeechAudioState',
    'DISPID_SVAlertBoundary', 'SVP_4', 'ISpeechRecoGrammar',
    'DISPID_SDKDeleteKey', 'DISPID_SLWsItem',
    ...
    'DISPID_SVSLastResult', 'SECFEmulateResult', 'SPGRAMMARWORDTYPE',
    'DISPID_SPELexicalForm', 'ISpeechGrammarRuleStateTransition',
    'SECLowConfidence', 'SGDSInactive', 'DISPID_SRCESoundEnd',
    'SPGRAMMARSTATE', 'SPVPRI_NORMAL', 'SPEI_MAX_SR',
    'DISPID_SpeechAudioStatus', 'DISPID_SASFreeBufferSpace',
    'SPEI_UNDEFINED', 'DISPIDSPTSI', 'SpeechVoiceSkipTypeSentence',
    'SBOPause', 'SP_VISEME_10', 'DISPID_SOTRemove', 'SPGS_EXCLUSIVE',
    'SpeechPropertyComplexResponseSpeed', 'SpeechEngineProperties',
    'SGPronounciation', 'SDA_Consume_Leading_Spaces',
    'DISPID_SOTsItem', 'SVSFlagsAsync', 'DISPID_SVEBookmark',
    'DISPID_SVEWord', 'SPEI_TTS_BOOKMARK', 'SSFMOpenForRead',
    'SpLexicon', 'DISPID_SVAudioOutputStream', 'DISPID_SRIsShared',
    'SGDisplay', 'eLEXTYPE_PRIVATE18', 'DISPID_SRGState', 'SASStop',
    'DISPID_SRCRecognizer', 'SpeechAudioProperties', 'DISPID_SGRName',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRProfile',
    'SRADefaultToActive', 'SREBookmark', 'SPXRO_Alternates_SML',
    'SPINTERFERENCE_TOOFAST', 'SpeechRecognizerState', 'SPEI_MIN_SR',
    'SpeechRecognitionType', 'ISpeechResourceLoader',
    'DISPID_SVIsUISupported', 'SPAS_PAUSE', 'ISpPhrase',
    'SDA_No_Trailing_Space', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SGRsCommit', 'SPCATEGORYTYPE', 'SDKLLocalMachine',
    'SPFILEMODE', 'ISpRecoResult', 'SpeechVoicePriority',
    'ISpeechGrammarRuleState', 'SRAONone', 'ISpRecoGrammar',
    'DISPID_SpeechAudioBufferInfo', 'SAFT8kHz8BitStereo',
    'SAFTCCITT_uLaw_11kHzStereo', 'SVP_16', 'DISPID_SpeechPhraseRule',
    'SpCustomStream', 'SPPARTOFSPEECH', 'SPINTERFERENCE_NONE',
    'SRSInactive', 'DISPID_SMSALineId', 'SAFT16kHz8BitMono',
    'SAFT24kHz16BitMono', 'ISpStreamFormat', 'DISPID_SGRSTPropertyId',
    'DISPID_SRCPause', 'SPDKL_LocalMachine', 'SPAUDIOOPTIONS',
    'ISpeechMemoryStream', 'SGDSActive', 'SpeechCategoryAudioOut',
    'IStream', 'DISPID_SLWLangId', 'DISPID_SPIRetainedSizeBytes',
    'SP_VISEME_1', 'DISPID_SRGetPropertyNumber', 'SRAInterpreter',
    'SAFTCCITT_uLaw_8kHzStereo', 'SAFT12kHz8BitStereo',
    'ISpeechTextSelectionInformation', 'DISPID_SpeechRecoResult',
    'SpeechAudioFormatGUIDText', 'DISPID_SVEventInterests',
    'SAFTADPCM_44kHzStereo', 'SPVPRI_OVER',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechPhraseAlternates', 'SVSFVoiceMask', 'SPVISEMES',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPAsItem', 'DISPID_SRIsUISupported',
    'SDTProperty', 'ISpProperties', 'SPEI_ADAPTATION',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SABIBufferSize',
    'DISPID_SVGetVoices', 'DISPID_SGRClear',
    'DISPID_SpeechGrammarRules', 'ISpObjectWithToken',
    'DISPID_SLRemovePronunciation', 'DISPID_SPPsCount',
    'SPEI_SOUND_START', 'DISPID_SRGRules',
    'DISPID_SVSyncronousSpeakTimeout', 'SVP_13', 'eLEXTYPE_PRIVATE13',
    'SRTEmulated', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SRGDictationUnload', 'SP_VISEME_3', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechXMLRecoResult', 'SASPause', 'SPSHORTCUTTYPE',
    'SPEI_MAX_TTS', 'SPCS_ENABLED',
    'DISPID_SpeechObjectTokenCategory', 'SGRSTTEpsilon',
    'SAFT24kHz8BitMono', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRRTimes', 'SVP_17', 'SVEViseme', 'SAFTText',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRRTStreamTime',
    '_ISpeechVoiceEvents', 'DISPID_SPRuleConfidence',
    'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_RECO_OTHER_CONTEXT', 'SPPS_SuppressWord',
    'SAFTGSM610_8kHzMono', 'DISPID_SRAudioInput', 'DISPID_SGRsCount',
    'SPLEXICONTYPE', 'SITooQuiet', 'DISPID_SRCEInterference',
    'SPEI_RECOGNITION', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SPILanguageId', 'DISPID_SPIReplacements',
    'SDKLCurrentUser', 'DISPID_SVVoice', 'SpeechAddRemoveWord',
    'DISPID_SOTGetAttribute', 'DISPID_SpeechMemoryStream',
    'SDA_One_Trailing_Space', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SOTCDefault', 'SGRSTTTextBuffer', 'SWTAdded',
    'DISPID_SRCSetAdaptationData', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SVEEnginePrivate', 'DISPID_SRSCurrentStreamNumber',
    'SAFTNonStandardFormat', 'DISPID_SRCEAdaptation', 'DISPID_SOTCId',
    'SpResourceManager', 'ISpGrammarBuilder', 'SPBO_NONE',
    'SpSharedRecognizer', 'SAFT24kHz8BitStereo', 'SRTReSent',
    'SAFTCCITT_ALaw_11kHzStereo', 'SINone', 'ISpeechPhraseRule',
    'DISPID_SpeechRecognizerStatus', 'ISpeechGrammarRules',
    'ISpeechPhoneConverter', 'IInternetSecurityMgrSite',
    'SGDSActiveUserDelimited', 'DISPID_SVWaitUntilDone',
    'DISPID_SPRules_NewEnum', 'DISPID_SLPSymbolic', 'SPLOADOPTIONS',
    'DISPID_SRRSetTextFeedback', 'ISpeechPhraseInfo', 'SVSFIsXML',
    'SPCT_SUB_COMMAND', 'DISPID_SASNonBlockingIO',
    'SpeechTokenIdUserLexicon', 'SpeechDiscardType',
    'DISPID_SpeechPhraseProperties', 'SPAUDIOSTATUS', 'SDTAll',
    'SASRun', 'SVP_14', 'SWPUnknownWordUnpronounceable',
    'DISPID_SRDisplayUI', 'SpeechBookmarkOptions',
    'DISPID_SRRGetXMLResult', 'DISPID_SpeechPhraseProperty',
    'SSSPTRelativeToEnd', 'DISPID_SpeechObjectTokens',
    'ISpeechAudioBufferInfo', 'DISPID_SVVolume', 'DISPID_SAFGuid',
    'SAFT44kHz8BitStereo', 'eLEXTYPE_PRIVATE5', 'SAFT44kHz16BitMono',
    'DISPID_SRGetRecognizers', 'DISPID_SPIRule', 'SPEI_SOUND_END',
    'SPWT_DISPLAY', 'SpNullPhoneConverter',
    'DISPID_SRGIsPronounceable', 'SPSVerb', 'SpPhoneConverter',
    'SPEI_TTS_AUDIO_LEVEL', 'SREStreamEnd', 'SPSUnknown',
    'DISPID_SRCEEndStream', 'DISPID_SRCEventInterests', 'SPSHT_EMAIL',
    'SPSTREAMFORMATTYPE', 'SPBO_TIME_UNITS', 'SREInterference',
    'DISPID_SPCLangId', 'SpMemoryStream', 'DISPID_SVSLastBookmarkId',
    'SPSHT_NotOverriden', 'SRSEIsSpeaking', 'DISPID_SMSAMMHandle',
    'DISPID_SpeechRecoResult2', 'DISPID_SWFEExtraData',
    'SPINTERFERENCE_TOOLOUD', 'SpMMAudioIn',
    'DISPID_SpeechBaseStream', 'ISpeechPhraseAlternates',
    'SPEI_WORD_BOUNDARY', 'DISPID_SVSRunningState',
    'DISPID_SRRRecoContext', 'SVP_6', 'DISPID_SPACommit',
    'DISPID_SpeechPhraseInfo', 'SpeechStreamFileMode',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SpeechAllElements',
    'tagSPTEXTSELECTIONINFO', 'WAVEFORMATEX',
    'SpStreamFormatConverter', 'DISPID_SAStatus',
    'DISPID_SRSetPropertyString', 'DISPID_SGRSAddRuleTransition',
    'SPSHORTCUTPAIR', 'DISPID_SpeechVoiceStatus', 'SPAR_High',
    'DISPID_SPEEngineConfidence', 'SRTExtendableParse',
    'eLEXTYPE_PRIVATE11', 'SVF_Stressed', 'SPSHT_Unknown',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRGetFormat', 'SPWORD',
    'DISPID_SGRSTWeight', 'DISPID_SRGetPropertyString',
    'SpeechCategoryAppLexicons', 'DISPID_SPIEngineId',
    'DISPID_SVGetAudioInputs', 'SAFT8kHz8BitMono', 'SVP_1',
    'SPWT_PRONUNCIATION', 'SRERecognition', 'SPSNoun',
    'DISPID_SWFESamplesPerSec', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SRRPhraseInfo', 'ISpeechRecognizerStatus',
    'DISPID_SRGDictationSetState', 'tagSTATSTG', 'SDTReplacement',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SGRSAddSpecialTransition',
    'SPSERIALIZEDRESULT', 'SWPUnknownWordPronounceable',
    'DISPID_SpeechLexiconWord', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRRAudio',
    'DISPID_SPRulesItem', 'SREAudioLevel', 'SVEPrivate', 'SVP_12',
    'DISPID_SGRSRule', 'STCRemoteServer',
    'SpeechEmulationCompareFlags', 'ISpAudio', 'ISpPhoneConverter',
    'DISPID_SPPParent', 'DISPID_SPIEnginePrivateData',
    'SVSFPurgeBeforeSpeak', 'eLEXTYPE_PRIVATE3',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRCRetainedAudioFormat',
    'SSFMCreateForWrite', 'DISPIDSPRG', 'SAFT11kHz8BitStereo',
    ...
    'SDTAudio', 'eLEXTYPE_PRIVATE15', 'DISPID_SpeechXMLRecoResult',
    'SpeechTokenValueCLSID', 'DISPID_SMSSetData',
    'DISPID_SWFEBlockAlign', 'DISPID_SVGetProfiles', 'SVP_18',
    'SPPS_Verb', 'DISPID_SPRuleChildren', 'eLEXTYPE_PRIVATE20',
    'SpeechPropertyAdaptationOn', 'DISPID_SLPPhoneIds',
    'ISpeechRecoResult2', 'ISpStream', 'DISPID_SPIProperties',
    'SPEI_END_SR_STREAM', '_RemotableHandle', 'SSTTTextBuffer',
    'eLEXTYPE_RESERVED10', 'DISPID_SpeechPhraseReplacement',
    'SpPhoneticAlphabetConverter', 'DISPID_SRCEAudioLevel',
    'DISPID_SFSOpen', 'DISPID_SRSetPropertyNumber', 'SPEI_PHONEME',
    'DISPID_SOTGetDescription', 'DISPID_SDKGetlongValue',
    'ISpRecoGrammar2', 'DISPID_SGRAttributes', 'SGRSTTWord',
    'SPEVENTENUM', 'ISpPhoneticAlphabetConverter',
    'eLEXTYPE_PRIVATE10', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SVEAudioLevel', 'SpMMAudioOut', 'DISPID_SAVolume',
    'ISpLexicon', 'SPDKL_CurrentUser', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SVDisplayUI', 'SVESentenceBoundary',
    'DISPID_SDKSetStringValue', 'SPRULE', 'SAFT8kHz16BitMono',
    'SSSPTRelativeToCurrentPosition', 'SECHighConfidence',
    'DISPID_SVPriority', 'SDTPronunciation', 'SVPNormal',
    'DISPID_SGRSAddWordTransition', 'SPCT_DICTATION', 'SPPS_Function',
    'SpObjectTokenCategory', 'SLTUser',
    ...
    'SP_VISEME_0', 'DISPID_SGRsCommitAndSave', 'SGSEnabled',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRSSupportedLanguages',
    'ISpVoice', 'DISPID_SRRAlternates', 'SPCT_COMMAND',
    'SPEI_SENTENCE_BOUNDARY', 'SPEI_RESERVED3', 'STSF_FlagCreate',
    'SPPROPERTYINFO', 'DISPID_SRCEPropertyNumberChange', 'ISpDataKey',
    'DISPID_SLGetGenerationChange', 'ISpeechRecoResultDispatch',
    'SAFTADPCM_22kHzMono', 'SP_VISEME_5', 'SPAS_CLOSED',
    'SREPropertyNumChange', 'SDTRule', 'SVSFParseAutodetect',
    'ISpeechRecoContext', 'DISPID_SADefaultFormat', 'SSFMCreate',
    'SVEEndInputStream', 'DISPID_SPPValue', 'DISPID_SPRsCount',
    'SVEAllEvents', 'DISPID_SRSAudioStatus', 'SVF_None',
    'ISpeechCustomStream', 'SpeechTokenKeyFiles', 'eLEXTYPE_PRIVATE7',
    'SECFIgnoreCase', 'DISPID_SLWType', 'DISPID_SOTs_NewEnum',
    'DISPID_SpeechMMSysAudio', 'SPRECOGNIZERSTATUS',
    'DISPID_SRRAudioFormat', 'SPEI_RECO_STATE_CHANGE',
    'ISpObjectTokenCategory', 'SAFT32kHz16BitMono', 'ISpRecognizer2',
    'SPPS_Noncontent', 'SPVPRI_ALERT', 'ISpeechFileStream',
    'DISPID_SOTId', 'DISPID_SDKCreateKey',
    'DISPID_SPPEngineConfidence', 'SPPS_Modifier', 'SPWAVEFORMATTYPE',
    'DISPID_SVSInputWordLength', 'SpWaveFormatEx',
    'ISpeechAudioFormat', 'SPDATAKEYLOCATION', 'DISPID_SLPsItem',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPARecoResult',
    'SpeechLoadOption', 'SVPAlert', 'DISPID_SCSBaseStream',
    'DISPID_SGRSTsItem', 'SPPHRASERULE', 'DISPID_SGRSTType',
    'SPBO_AHEAD', 'SAFT22kHz16BitMono', 'SPWF_SRENGINE',
    'DISPID_SPPFirstElement', 'SPEI_RESERVED6', 'SPPS_Noun',
    'SECNormalConfidence', 'SPFM_CREATE_ALWAYS', 'SFTInput',
    'DISPID_SAFSetWaveFormatEx', 'STSF_CommonAppData',
    'SREStreamStart', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SBSFormat', 'SREFalseRecognition',
    'DISPID_SRCreateRecoContext', 'SRAImport',
    'SpeechCategoryRecognizers', 'SAFTDefault', 'STSF_AppData',
    'DISPID_SRCBookmark', 'DISPID_SRCERequestUI', 'SPCS_DISABLED',
    'SpeechWordPronounceable', 'SpTextSelectionInformation',
    'SPTEXTSELECTIONINFO', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechPropertyResourceUsage', 'SpeechGrammarState', 'LONG_PTR',
    'SPFM_CREATE', 'DISPID_SRGCmdLoadFromResource', 'SPCT_SLEEP',
    'SPPS_RESERVED3', 'SVEBookmark', 'SPWORDLIST',
    'DISPID_SpeechDataKey', 'SVP_21', 'DISPID_SPIStartTime',
    '__MIDL_IWinTypes_0009', 'SpVoice', 'IInternetSecurityManager',
    'SpeechGrammarRuleStateTransitionType', 'eLEXTYPE_USER',
    'SP_VISEME_12', 'SPEI_START_SR_STREAM',
    'DISPID_SpeechPhraseAlternate', 'SPEI_RESERVED5',
    'DISPID_SVEStreamEnd', 'ISpRecoContext2', 'SPSHT_OTHER',
    'SREHypothesis', 'DISPID_SPRText', 'DISPID_SRCVoice',
    'SP_VISEME_2', 'SpeechStreamSeekPositionType', 'SPPS_RESERVED1',
    'DISPID_SOTGetStorageFileName', 'ISpeechAudio',
    'eLEXTYPE_RESERVED7', 'SAFTADPCM_11kHzMono',
    'DISPID_SRCEFalseRecognition', 'Speech_Max_Pron_Length',
    'ISpeechLexiconPronunciations', 'SVEVoiceChange',
    ...
    'SVP_19', 'SPAR_Unknown', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechInterference', 'DISPID_SpeechRecoContextEvents',
    'SRATopLevel', 'SECFIgnoreKanaType', 'DISPID_SOTSetId',
    'SAFTADPCM_22kHzStereo', 'ISpeechDataKey',
    'DISPID_SRGSetTextSelection', 'DISPID_SOTCategory',
    'SPPS_Unknown', 'DISPID_SVResume', 'SAFT12kHz8BitMono',
    'SRSInactiveWithPurge', 'DISPIDSPTSI_SelectionOffset',
    'ISpXMLRecoResult', 'DISPID_SRRecognizer', 'SAFTNoAssignedFormat',
    'SBONone', 'SVP_20', 'SPSInterjection', 'SINoSignal',
    'DISPID_SVSLastBookmark', 'SREPropertyStringChange',
    'DISPID_SLPType', 'ISpeechLexicon', 'DISPID_SVSVisemeId',
    'SPSFunction', 'SPRECORESULTTIMES',
    'DISPID_SPRuleNumberOfElements', 'SpShortcut',
    'DISPID_SOTIsUISupported', 'SVPOver', 'STSF_LocalAppData',
    'DISPID_SRCEBookmark', 'DISPID_SPEs_NewEnum', 'SWTDeleted',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SREmulateRecognition',
    ...
    'DISPID_SABIMinNotification', 'DISPID_SRRTTickCount', 'SPEVENT',
    'SPAS_RUN', 'SpeechRuleState', 'DISPID_SDKSetLongValue',
    ...
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRRSaveToMemory',
    'SAFTGSM610_44kHzMono', 'DISPID_SVEViseme', 'SPSEMANTICERRORINFO',
    'SPAUDIOSTATE', 'SPSMF_SAPI_PROPERTIES', 'SRSActiveAlways',
    'DISPID_SLGetWords', 'DISPID_SLWWord', 'SVSFNLPMask',
    'SPBO_PAUSE', 'SPAR_Low', 'SpFileStream',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPEI_END_INPUT_STREAM',
    'DISPID_SPPs_NewEnum', 'SPCONTEXTSTATE', 'SPRECOSTATE',
    'SAFT16kHz16BitStereo', 'SAFTADPCM_44kHzMono',
    'DISPID_SPAPhraseInfo', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SpeechAudio', 'SRTSMLTimeout', 'SLTApp', 'DISPID_SAFType',
    'SpeechRetainedAudioOptions', 'SPSModifier', 'SPSNotOverriden',
    'DISPID_SPRs_NewEnum', 'DISPID_SVStatus',
    'DISPID_SpeechRecoContext', 'DISPID_SVEStreamStart',
    'DISPID_SPPChildren', 'DISPID_SPEsCount', 'DISPID_SVSpeak',
    'SAFTCCITT_ALaw_22kHzMono', 'SP_VISEME_19',
    'SpeechCategoryAudioIn', 'SpeechAudioVolume', 'DISPID_SRGReset',
    'DISPID_SDKGetBinaryValue', 'SPINTERFERENCE_NOSIGNAL',
    'SREAdaptation', 'SPSERIALIZEDPHRASE', 'SPAS_STOP',
    'DISPID_SRCCreateGrammar', 'SP_VISEME_21', 'DISPID_SWFEFormatTag',
    'SAFTADPCM_11kHzStereo', 'ISpShortcut', 'DISPID_SPRuleParent',
    'SP_VISEME_11', 'SpeechRecoContextState', 'SVP_8', 'SVSFDefault',
    'ISpeechPhraseElement', 'SGRSTTDictation', 'SpeechLexiconType',
    'ISpNotifySource', 'SPEI_START_INPUT_STREAM',
    'ISpeechObjectTokens', 'SpeechAudioFormatType', 'SP_VISEME_16',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPVOICESTATUS', 'SRERequestUI',
    'ISpeechPhraseInfoBuilder', 'STCInprocHandler',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SASState',
    'DISPID_SPISaveToMemory', 'SAFT48kHz8BitMono', 'SPSLMA',
    'DISPID_SPRuleName', 'SGRSTTWildcard', 'ISpNotifyTranslator',
    'SPGS_ENABLED', 'SGSDisabled', 'DISPID_SPRuleId',
    'DISPID_SPIGrammarId', 'SpeechAudioFormatGUIDWave',
    'SPINTERFERENCE_NOISE', 'DISPID_SWFEAvgBytesPerSec',
    'SpeechVoiceSpeakFlags', 'SGSExclusive', 'DISPID_SVPause',
    'DISPID_SLGenerationId', 'SPPS_Interjection',
    'SpNotifyTranslator', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPEI_PHRASE_START', 'SSTTWildcard', 'SPLO_DYNAMIC',
    'SECFNoSpecialChars', 'SPVPRIORITY',
    'DISPID_SPRDisplayAttributes', 'DISPID_SpeechLexiconProns',
    'SVSFIsFilename', 'DISPID_SOTCGetDataKey', 'DISPID_SRRSpeakAudio',
    'SpInprocRecognizer', 'SVP_10', 'ISpMMSysAudio', 'STCLocalServer',
    'SVSFParseMask', 'SAFT48kHz8BitStereo', 'SDKLDefaultLocation',
    'SRSEDone', 'IEnumSpObjectTokens', 'ISpeechAudioStatus',
    'SpeechDisplayAttributes', 'SpeechRegistryLocalMachineRoot',
    'eLEXTYPE_RESERVED8', 'UINT_PTR', 'SPAO_NONE',
    'DISPID_SpeechVoiceEvent', 'SVP_11', 'SPAUDIOBUFFERINFO',
    'DISPID_SASCurrentDevicePosition'
]

_check_version('1.2.1', 1700082396.983745)
